...
START_OF_HTTP_PAGE_DATABASE(soft_ap_http_pages)
    ...
    { "/hello", "text/html", WICED_STATIC_URL_CONTENT, .url_content.static_data = {SOFT_AP_MSG, sizeof(SOFT_AP_MSG)-1 }},
...
// IMPORTANT: Update line 923 of softap.cpp if you change the number of pages here.
